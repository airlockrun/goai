...
func getProvider() *Provider {
	return New(Options{APIKey: os.Getenv("FAL_API_KEY")})
}
...
func TestIntegration_ImageGeneration(t *testing.T) {
	...
	t.Run("fal-ai/flux/schnell", func(t *testing.T) {
	...
	t.Run("fal-ai/flux-pro", func(t *testing.T) {
		m := p.ImageModel("fal-ai/flux-pro")
		...
		t.Logf("Generated image with flux-pro")
	})
}
