...
func getProvider() *Provider {
	return New(Options{APIKey: os.Getenv("CEREBRAS_API_KEY")})
}
...
func TestIntegration_GenerateText(t *testing.T) {
	...
	t.Run("llama3.1-8b", func(t *testing.T) {
		m := p.LanguageModel("llama3.1-8b")
	...
	t.Run("qwen-3-235b-a22b-instruct-2507", func(t *testing.T) {
		m := p.LanguageModel("qwen-3-235b-a22b-instruct-2507")
		ctx, cancel := context.WithTimeout(context.Background(), 30*time.Second)
		defer cancel()
