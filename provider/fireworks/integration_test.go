...
func getProvider() *Provider {
	return New(Options{APIKey: os.Getenv("FIREWORKS_API_KEY")})
}
...
func TestIntegration_GenerateText(t *testing.T) {
	...
	t.Run("accounts/fireworks/models/llama-v3p1-8b-instruct", func(t *testing.T) {
		m := p.LanguageModel("accounts/fireworks/models/llama-v3p1-8b-instruct")
...
func TestIntegration_Embeddings(t *testing.T) {
	skipIfNoKey(t)
	p := getProvider()
	m := p.EmbeddingModel("nomic-ai/nomic-embed-text-v1.5")
